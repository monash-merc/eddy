            ...
            Modified date: <@s.date name="collection.modifiedTime" format="yyyy-MM-dd hh:mm" />
                        ...
                        <div class="data_action_link2">
                            ...
                            <@s.if test="%{permissionBean.deleteAllowed}">
                                <div class="msg_content">All data will be removed from the repository permanently!<p>Are
                            ...
                            <@s.if test="%{licence.licenceType == 'tern'}">
                                <div class="tern_licence_div">
                                    <div class="tern_licence">
                                        <div class="licence_logo"><a
                                                    href="http://www.tern.org.au/datalicence/TERN-BY-SA-NC/1.0"
                                                    target="_blank">http://www.tern.org.au/datalicence/TERN-BY-SA-NC/1.0</a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <img src="${base}/images/tern_by_nc_sa.png"/></div>
                                        <p>
                                            The TERN Attribution-Share Alike- Non Commercial (TERN BY-SA-NC) Data
                                            Licence v1.0 restricts the development of new data/products, so that a user
                                            can:
                                        </p>
                                        <ul>
                                        ...
                                        <p>
                                            provided that, whenever the data is copied, re-used, or distributed the user
                                            ensures that:
                                        </p>
                                        <ul>
                                            <li>credit is given to the original sources/s of the data (and any other
                                                nominated parties) in the manner stipulated (Attribution);
                                            </li>
                                            <li>the data cannot be used for commercial purposes (No Commercial); and
                                            </li>
                                            <li>If the data is altered, transformed, the resulting datasets can only be
                                                used under the same license conditions.
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="data_display_div">
                        ...
                        <@s.else>
                            <div class="citation_hints">If you make use of this collection in your research, please
                                cite:
                            </div>
                            <div class="citation_contents_div">
                                <@s.property value='collection.owner.firstName' />  <@s.property value='collection.owner.lastName' />
                                (<@s.date name="collection.createdTime" format="yyyy" />
                                ) <@s.property value="collection.name"/>
                                ...
                                <@s.form id="ajaxFileUploadForm" onsubmit="return false" action="importFile.jspx" namespace="/data" method="post" enctype="multipart/form-data" >
                                    ...
                                    <div class="input_field_row">
                                        ...
                                        <div class="input_field_value_section">
                                            ...
                                            <div class="blank_separator"></div>
                                            <div class="comments">
                                                <a href="${base}/site/netcdf.jspx" target="_blank">Please follow the
                                                    NetCDF file naming convention</a></li>
                                            </div>
                                        </div>
                                    </div>
                                    <div style="clear: both;"></div>
                                        ...
                                        <div class="im_ra_section">
                                            ...
                                            <div class="im_ra_input_panel">
                                                ...
                                                <div class="ra_field_title">
                                                    <span class="ra_span">Start Date</span>:
                                                    &nbsp;&nbsp; <@s.date name="restrictAccess.startDate" format="yyyy-MM-dd" />
                                                </div>
                                                <div class="ra_field_value_section">
                                                    <span class="ra_span">End Date</span>:
                                                    &nbsp;&nbsp; <@sj.datepicker name="restrictAccess.endDate" id="raEndTime" displayFormat="yy-mm-dd"  buttonImageOnly="true" />
                                                </div>
                                                <div class="blank_separator"></div>
                                                <div class="ra_comments">
                                                    (The start date is always the upload date. The end date must not be
                                                    more than 18 months away from the start date)
                                                </div>
                                            </div>
                                        </div>
                                    </@s.if>
                                ...
                                <div class="ds_ra_act_level">
                                    <div class="ds_ra_info">
                                        ...
                                        <@s.if test="%{permissionBean.racAllowed}">
                                            <@s.if test="%{(#raDs.raEnabled == true && #raDs.raExpired == false) || (#raDs.raEnabled == false && #raDs.raQualified == true)}">
                                                <div class="ra_control1" id="${dsState.index?c}"
                                                     title="Manage restricted access"></div>
                                            </@s.if>
                                        </@s.if>
                                    </div>
                                    ...
                                    <div class="ds_act_info">
                                        <div class="ds_act_link">
                                            <@s.if test="%{permissionBean.viewAllowed}">
                                                <@s.if test="%{#raDs.dataset.extracted}">
                                                    <a href="${base}/${viewDatasetLink}?dataset.id=<@s.property value='#raDs.dataset.id' />&collection.id=<@s.property value='collection.id' />&collection.owner.id=<@s.property value='collection.owner.id' />&viewType=${viewType}"
                                                       title="Dataset - ${raDs.dataset.name}"
                                                       rel="superbox[iframe.viewmetadata][600x500]">
                                                        View Metadata
                                                    </a>
                                                </@s.if>
                                            </@s.if>
                                            <@s.if test="%{(#raDs.raEnabled == true && #raDs.raExpired == false)}">
                                                <@s.if test="%{permissionBean.exportAllowed}">
                                                    <a href="${base}/${downloadDatasetLink}?dataset.id=<@s.property value='#raDs.dataset.id' />&collection.id=<@s.property value='collection.id' />&collection.owner.id=<@s.property value='collection.owner.id' />&viewType=${viewType}"
                                                       title="Exporting Dataset - ${raDs.dataset.name}"
                                                       rel="superbox[iframe.viewmetadata][600x640]">
                                                        Export
                                                    </a>
                                                </@s.if>
                                            </@s.if>
                                            ...
                                            <@s.if test="%{permissionBean.deleteAllowed}">
                                                <div id='confirm_dialog'>
                                                    <div class="msg_content">The data will be removed from the
                                        ...
                                        <div class="dataset_ra_section" id="ds_ra_${dsState.index?c}">
                                            ...
                                            <div class="ds_ra_input_panel">
                                                ...
                                                <div class="ra_field_title">
                                                    ...
                                                    <span class="ra_span">Start Date</span>:
                                                    &nbsp;&nbsp; <@s.date name="#raDs.ra.startDate" format="yyyy-MM-dd" />
                                                </div>
                                                ...
                                                <div class="ra_comments">
                                                    (The end date must not be more than 18 months away from the start
                                                    date)
                                                </div>
