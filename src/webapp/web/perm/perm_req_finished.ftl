            ...
            <@s.if test="%{actionSuccessMsg != null}">
                ...
                <@s.form action="applyForPerms.jspx" namespace="/perm" method="post" >
                    ...
                    <table class="display_data_tab" id="permission_req">
                        ...
                        <tr>
                            <td>
                                <@s.checkbox name="permReq.viewAllowed" cssClass="check_box" disabled="true" />
                            </td>
                            <td>
                                <@s.checkbox name="permReq.updateAllowed" cssClass="check_box" disabled="true" />
                            </td>
                            <td>
                                <@s.checkbox name="permReq.importAllowed" cssClass="check_box" disabled="true" />
                            </td>
                            <td>
                                <@s.checkbox name="permReq.exportAllowed" cssClass="check_box" disabled="true" />
                            </td>
                            <td>
                                <@s.checkbox name="permReq.deleteAllowed" cssClass="check_box" disabled="true" />
                            </td>
                            <td>
                                <@s.checkbox name="permReq.changePermAllowed" cssClass="check_box" disabled="true" />
                            </td>
                        </tr>
                        </tbody>
                    </table>
