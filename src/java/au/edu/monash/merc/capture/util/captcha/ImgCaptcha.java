package au.edu.monash.merc.capture.util.captcha;
...
public class ImgCaptcha implements Serializable {
	...
	public static void main(String[] args) throws Exception {
		...
		ImgCaptcha captcha = new ImgCaptcha.Builder(200, 45).addText().addBackground(new GradiatedBackgroundProducer()).gimp().addNoise().addBorder()
				.build();
