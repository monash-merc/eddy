...
<div class="title_panel">
    ...
    <div class="div_inline"><a href="${base}/site/utilities.jspx"><@s.text name="site.utilities.action.title" /></a>
    </div>
</div>
            ...
            <div class="left_display_inner">
                <div class="content_none_border_div">
                    ...
                    <div class="paragraph_div">
                        ...
                        available <a href="http://www.unidata.ucar.edu/software/netcdf/" target="_blank">here</a> and
                    ...
                    <div class="paragraph_div">
                        ...
                        NetCDF files.
                        OzFlux uses and recommends the <a href="https://conda.io/miniconda.html" target="_blank">Miniconda
                            Python V3+ Distribution</a> for manipulating the NetCDF data files available on this portal.
                    </div>

                    <div class="paragraph_div">
                        Libraries for reading and writing NetCDF files are also available for Fortran, C and other
                        programming languages, see
                        the <a href="http://www.unidata.ucar.edu/software/netcdf/software.html"
                               target="_blank">UniData</a> web site for details.
                    </div>

                    <div class="paragraph_div">
                        Various command line utilities are also available for viewing the contents of NetCDF files such
                        as ncBROWSE and ncVIEW,
                        see the <a href="http://www.unidata.ucar.edu/software/netcdf/software.html" target="_blank">UniData</a>
                    ...
                    <div class="paragraph_div">
                        ...
                        <a href="https://github.com/OzFlux/PyFluxPro" target="_blank">PyFluxPro</a>.
                        PyFluxPro can read NetCDF files and plot timeseries and fingerprints.
                    </div>
                    <!-- <div class="paragraph_div">
                        An add-in that allows Excel to read and write NetCDF files is also available from
                        <a href="http://code.google.com/p/netcdf4excel" target="_blank">here</a>.
