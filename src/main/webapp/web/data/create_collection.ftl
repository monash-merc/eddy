...
<div class="title_panel">
    ...
    <div class="div_inline"><a
                href="${base}/data/listUserCollections.jspx"><@s.text name="mycollection.nav.label.name" /></a></div>
    <div class="div_inline"><img src="${base}/images/link_arrow.png" border="0"/></div>
                ...
                <@s.form action="createCollection.jspx" namespace="/data" method="post">
                                ...
                                <div class="licence_options">
                                    <div class="licence_option_row" id="tern_option">
                                        ...
                                        <@s.if test="%{licence.licenceType == 'tern'}">
                                            <input type="radio" name="licence.licenceType" value="tern"
                                                   checked="checked" class="radio_box">TERN Licence (Recommended)
                                        </@s.if>
                                        <@s.else>
                                            <input type="radio" name="licence.licenceType" value="tern"
                                                   class="radio_box">TERN Licence (Recommended)
                                        </@s.else>
                                    </div>
                                    <div class="licence_option_row" id="user_defined_option">
                                        <@s.if test="%{licence.licenceType == 'userdefined'}">
                                            <input type="radio" name="licence.licenceType" value="userdefined"
                                                   checked="checked" class="radio_box">Define Your Own Licence
                                        </@s.if>
                                        <@s.else>
                                            <input type="radio" name="licence.licenceType" value="userdefined"
                                                   class="radio_box">Define Your Own Licence
                                        </@s.else>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="input_field_row">
                            ...
                            <div class="input_field_value_section">
                                ...
                                <div class="licence_contents_div">
                                    ...
                                    <div class="comments">
                                        User-defined data
                                        licence. <@s.text name="licence.add.user.defined.licence.hint" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="content_div">
                        ...
                        <div class="input_field_row" style="display: none;">
                            ...
                            <div class="input_field_value_section">
                                <@s.checkbox name="globalCoverage" id="global_coverage" cssClass="check_box" /> Global
                                Coverage
                                <div class="comments">
                                    ...
                                    <div class="comments">
                                        ...
                                        <ul id="comment_num_ul">
                                            <li>
                                                ...
                                                <ul>
                                                    <li>Use the map zoom and pan controls to zoom in to the area of the
                                                        site.
                                                    </li>
                                                    <li>Click on the <b>point</b> button.</li>
                                                    <li>Position the cross-hair cursor over the site location and click
                                            ...
                                            <li>
                                                ...
                                                <ul>
                                                    ...
                                                    <li>Enter the coordinates of the site into the pop-up box as
                                                        longitude and latitude separated by a comma
                                                        eg 148.15202,-35.65644 (Note: the coordinates must be in decimal
                                                        degrees)
                                                    </li>
                        ...
                        <div class="input_field_row">
                            ...
                            <div class="input_field_value_section">
                                <@s.submit value="%{getText('data.create.button')}" cssClass="input_button_style" />
