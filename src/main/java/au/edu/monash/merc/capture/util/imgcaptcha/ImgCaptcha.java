...
public class ImgCaptcha {
    ...
    public ImgCaptcha() {
        this.setConfig(new ImgConfig());
    }

    public ImgCaptcha(ImgConfig config) {
     ...
     */
    public GeneratedImgCaptcha generate() {
        ...
        return new GeneratedImgCaptcha(captchaImage, code);
    }
    ...
    private Font[] loadCustomFonts() {
        ...
        try {
            ...
            throw new CaptchaException("Load custom fonts failed!", e.getCause());
        }
    ...
    private Font getRandomFont() {
        ...
        int fontSize = config.getHeight() / 2 + random.nextInt(20) - 6;
