...
<div class="main_body_container">
	...
	<center><div class="main_install_head">System Installation</div></center>
	</div>
	<div class="install_none_border">
		<br />
		...
		<div class="main_install_inner">
			<table>
				<tr>
					...
					<td><div class="name_comment">* The application name</div></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><div class="name_comment">* The dataset physical location</div></td>
				</tr>
				<tr>
					<td>Administrator Name: </td>
					<td><@s.textfield name="appProp.adminName" cssClass="install_input_field" /></td>
					<td><div class="name_comment">* The system administrator name</div></td>
				</tr>
				<tr>
					<td>Administrator Email: </td>
					<td><@s.textfield name="appProp.adminEmail" cssClass="install_input_field" /></td>
					<td><div class="name_comment">* The system administrator email</div></td>
				</tr>
				<tr>
					<td>Administrator Password: </td>
					<td><@s.textfield name="appProp.adminPassword" cssClass="install_input_field" /></td>
					<td><div class="name_comment">* The system administrator password, if administrator is a ldap user, just put 'ldap' as password </div></td>
				</tr>
				<tr>
					<td>System Service Email: </td>
					<td><@s.textfield name="appProp.systemServiceEmail" cssClass="install_input_field" /></td>
					<td><div class="name_comment">* The system service email for sending and receiving emails</div></td>
				</tr>
				<tr>
					<td>Login Try Times: </td>
					<td><@s.textfield name="appProp.loginTryTimes" cssClass="install_input_field" /></td>
					<td><div class="name_comment">* An user can try login times</div></td>
				</tr>
				<tr>
					<td>Login Re-try Waiting Times: </td>
					<td><@s.textfield name="appProp.blockWaitingTimes" cssClass="install_input_field" /></td>
					<td><div class="name_comment">* Login re-try waiting times after ip blocked</div></td>
				</tr>
				<tr>
		...
		<div class="main_install_inner">
			<table>	
				...
				<tr>
					...
					<td><div class="name_comment">* The researcher master web service endpoint address</div></td>
				</tr>
				<tr>
					<td>Researcher Master Web Service Timeout: </td>
					<td><@s.textfield name="appProp.rmWsTimeout" cssClass="install_input_field" /></td>
					<td><div class="name_comment">* The researcher master web service timeout value</div></td>
				</tr>
			</table>
		</div>
		...
		<div class="main_install_inner">
			<table>
				<tr>
					...
					<td><div class="name_comment">* Ldap authentication supported</div></td>
				</tr>
				<tr>
					<td>LADP Server: </td>
					<td><@s.textfield name="ldapProp.ldapServer" cssClass="install_input_field" /></td>
					<td><div class="name_comment">* The ldap server</div></td>
				</tr>
				<tr>
					<td>Base DN: </td>
