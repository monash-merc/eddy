...
<registryObjects xmlns="http://ands.org.au/standards/rif-cs/registryObjects"
    ...
    <registryObject group="OzFlux: Australian and New Zealand Flux Research and Monitoring">
        ...
        <originatingSource>http://www.ozflux.org.au</originatingSource>
        <activity type="program">
            <identifier type="local">MON399d1cdc-a788-4a05-9f01-d3dcbcafdf8d</identifier>
            <name type="primary">
                <namePart>OzFlux Ecosystem Exchange Research Network</namePart>
            </name>
            <location>
                <address>
                    <electronic type="url">
                        <value>http://www.ozflux.org.au</value>
                    </electronic>
                </address>
            </location>
            ...
            <description type="full" xml:lang="en">
                &lt;p&gt;
                “OzFlux is a national ecosystem research network established to provide the Australian, New Zealand and global ecosystem modelling communities with nationally consistent observations
                of energy, carbon and water exchange between the atmosphere and key Australian and New Zealand ecosystems.
                &lt;/p&gt;
                &lt;p&gt;
                OzFlux is part of an international network of over 500 flux stations that is designed to provide continuous, long-term micrometteorological measurements to monitor the state of
                ecosystems globally.
                &lt;/p&gt;
                &lt;p&gt;
