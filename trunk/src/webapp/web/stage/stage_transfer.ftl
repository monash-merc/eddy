	...
	<@s.form id="stage_transfer"  action="stageTransfer.jspx" namespace="/data" method="post" >
	 	<div class="single_border_block">
			...
			<table align="center" width="100%">
				...
				<tr>
					...
					<td align="left"><span class="stage_pane_div">Ignore transferring if file already exists</span></td>
				</tr>
				<tr>
					<td align="right"><@s.checkbox name="sendEmailRequired" id="extract"  /></td>
					<td align="left"><span class="stage_pane_div">Send email notification after transferring finished</span></td>
				</tr>
				<tr>
					<td colspan="2"></td>
				</tr>
		...
		<div class="left_middle_no_border_panel">
			<table class="table_data" >
				<tr class="bg_grey_tr">
			 		<td width="100"><center>Select All <br/><@s.checkbox name="selectedAll" id="ds_select_all" /></center></td>
