...
<@s.form action="updateUDParty.jspx" namespace="/data" method="post">
    <div class="mcpop_field">
        ...
        <div class="mcpop_input_value">
                <span class="inline_span2">
                   Please edit a researcher information bellow:
                </span>
        </div>
        ...
        <div class="mcpop_input_value">
            <table width="450">
                ...
                <tr>
                    <td><@s.textfield name="addedPartyBean.personGivenName" cssClass="pop_input_field" readonly ="true"  /></td>
                </tr>
                <tr>
                    <td>
                        Last Name:
                ...
                <tr>
                    <td><@s.textfield name="addedPartyBean.personFamilyName" cssClass="pop_input_field" readonly ="true" /></td>
                </tr>
                <tr>
                    <td>
                        Email:
                ...
                <tr>
                    <td><@s.textfield name="addedPartyBean.email" cssClass="pop_input_field" readonly ="true"/></td>
                </tr>
                <tr>
                    <td>
                        Address:
                ...
                <tr>
                    ...
                    <@s.hidden name="addedPartyBean.id" />
                    <@s.hidden name="addedPartyBean.partyKey" />
			        <@s.hidden name="addedPartyBean.identifierType" />
			        <@s.hidden name="addedPartyBean.identifierValue"  />
			        <@s.hidden name="addedPartyBean.originateSourceType"  />
			        <@s.hidden name="addedPartyBean.fromRm"/>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="mcpop_bddiv">
        <input type="button" value=" Cancel " class="mcpop_button" onclick="window.location = '${base}/data/showSearchParty.jspx?searchCnOrEmail=${searchCnOrEmail}';"/> &nbsp;&nbsp; <input
            type="submit" name="options" value=" Update " class="mcpop_button"/>
    </div>
</@s.form>
</div>
</body>
