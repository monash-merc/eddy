	    ...
	    <@s.if test="%{addPartyType == 'rm_party'}">  
		    <@s.form action="addRMParty.jspx" namespace="/data" method="post">
		 	<div class="mcpop_field">
				...
				<div class="mcpop_input_value">
					<@s.textfield name="searchCnOrEmail" cssClass="input_field" /> 
			...
			<div class="mcpop_bddiv">
				<input type="button" value=" Back " class="mcpop_button" onclick="window.location = '${base}/data/addPartyOptions.jspx';" /> &nbsp;&nbsp; <input type="button"  value=" Cancel " class="mcpop_button" id="cancelAddParty" /> &nbsp;&nbsp; <input type="submit" name="options" value=" Next " class="mcpop_button" />
			</div>
			</@s.form>
		</@s.if>
		<@s.if test="%{addPartyType == 'user_defined_party'}">
			<@s.form action="addUDParty.jspx" namespace="/data" method="post">
				...
				<div class="mcpop_field">
					...
					<table width="450">
						...
						<tr>
							<td><@s.textfield name="addedPartyBean.originateSourceValue" cssClass="pop_input_field" /></td>
						</tr>
					</table>
					</div>
				</div>
