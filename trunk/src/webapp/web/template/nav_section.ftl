...
<div>
	<br/>
	<div class="menu_logo">
    	<a href="${base}/home"><img src="${base}/images/logo/ozflux_logo.gif" border="0"/></a>
...
<div class="main_menu_bar">
    <div class="main_menu_bar_center">
		...
		<a href="${base}/home" class="main_menu_link" style="border-right-width: 1px;border-right-style: solid;	border-right-color: #595E7B;">About Us</a>                            				
		<!-- Main Menu END-->
	</div>
</div>
