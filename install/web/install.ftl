...
<@s.form action="install.jspx" namespace="/install" method="post">
    ...
    <div class="main_install_inner">
        <table>
            ...
            <tr>
                <td>LADP Authentication Web Service Enabled:</td>
            ...
            <tr>
            <tr>
                <td colspan="3"><font color="#006400">Provide the following three fields when Ldap authentication
                    web service enabled</font></td>
            </tr>
            <tr>
                <td colspan="3"></td>
            <tr>
            <tr>
                <td width="250">LADP Authentication Web Service Host:</td>
            ...
            <tr>
                ...
                <td>
                    <div class="name_comment">* If ignore LADP authentication web service certificate error, please
                        select TRUE
                    </div>
                </td>
            </tr>
        </table>
        <table class="ldap_config_tab">
            <tr>
                <td colspan="3"></td>
            <tr>
            <tr>
                <td colspan="3"><font color="#006400">Provide the following Ldap fields when Ldap authentication
                    supported and ldap athentiction web service disabled</font></td>
            <tr>
            <tr>
                <td colspan="3"></td>
            <tr>
            <tr>
                <td width="250">LADP Server:</td>
            ...
            <tr>
                ...
                <td>
                    <div class="name_comment">* If binding the base dn required when connection to the ldap server
                    </div>
                </td>
            </tr>
            <tr>
