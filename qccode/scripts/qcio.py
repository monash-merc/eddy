...
def get_datetime(ds):
    ...
    for i in range(nRecs):
        ds.series['DateTime'].append(datetime.datetime(int(ds.series['Year']['Data'][i]),
...
def xl_write_series(cf,ds,level):
    ...
    #xlDataSheet.set_panes_frozen(True)
    #xlDataSheet.set_horz_split_pos(10)
    #xlDataSheet.set_vert_split_pos(1)
    #xlDataSheet.set_remove_splits(True)
    ...
    #xlDataSheet.write(9,xlCol,'xlDateTime',d_xf)
    ...
    #d_xf = xlwt.easyxf('font: height 160')
    #xlFlagSheet.write(9,xlCol,'xlDateTime',d_xf)
