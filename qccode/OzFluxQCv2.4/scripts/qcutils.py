...
def GetSeriesStats(cf,ds):
    ...
    xlRow = 0
    xlCol = 1
    xlFlagSheet.write(xlRow,xlCol,ds.globalattributes['Flag0'])
    xlFlagSheet.write(xlRow,xlCol+1,ds.globalattributes['Flag1'])
    xlFlagSheet.write(xlRow,xlCol+2,ds.globalattributes['Flag2'])
    xlFlagSheet.write(xlRow,xlCol+3,ds.globalattributes['Flag3'])
    xlFlagSheet.write(xlRow,xlCol+4,ds.globalattributes['Flag4'])
    xlFlagSheet.write(xlRow,xlCol+5,ds.globalattributes['Flag5'])
    xlFlagSheet.write(xlRow,xlCol+6,ds.globalattributes['Flag6'])
    xlFlagSheet.write(xlRow,xlCol+7,ds.globalattributes['Flag7'])
    xlFlagSheet.write(xlRow,xlCol+8,ds.globalattributes['Flag8'])
    xlFlagSheet.write(xlRow,xlCol+9,ds.globalattributes['Flag9'])
    xlFlagSheet.write(xlRow,xlCol+10,ds.globalattributes['Flag10'])
    xlFlagSheet.write(xlRow,xlCol+11,ds.globalattributes['Flag11'])
    xlFlagSheet.write(xlRow,xlCol+12,ds.globalattributes['Flag12'])
    xlFlagSheet.write(xlRow,xlCol+13,ds.globalattributes['Flag13'])
    xlFlagSheet.write(xlRow,xlCol+14,ds.globalattributes['Flag14'])
    xlFlagSheet.write(xlRow,xlCol+15,ds.globalattributes['Flag15'])
    xlFlagSheet.write(xlRow,xlCol+16,ds.globalattributes['Flag16'])
    xlFlagSheet.write(xlRow,xlCol+17,ds.globalattributes['Flag17'])
    xlFlagSheet.write(xlRow,xlCol+18,ds.globalattributes['Flag18'])
    xlFlagSheet.write(xlRow,xlCol+19,ds.globalattributes['Flag19'])
    xlFlagSheet.write(xlRow,xlCol+20,ds.globalattributes['Flag30'])
    xlFlagSheet.write(xlRow,xlCol+21,ds.globalattributes['Flag31'])
    xlFlagSheet.write(xlRow,xlCol+22,ds.globalattributes['Flag40'])
    xlFlagSheet.write(xlRow,xlCol+23,ds.globalattributes['Flag50'])
    xlFlagSheet.write(xlRow,xlCol+24,ds.globalattributes['Flag60'])
    xlFlagSheet.write(xlRow,xlCol+25,ds.globalattributes['Flag70'])
    xlFlagSheet.write(xlRow,xlCol+26,ds.globalattributes['Flag80'])
    xlFlagSheet.write(xlRow,xlCol+27,ds.globalattributes['Flag81'])
    xlFlagSheet.write(xlRow,xlCol+28,ds.globalattributes['Flag82'])
    xlFlagSheet.write(xlRow,xlCol+29,ds.globalattributes['Flag83'])
    ...
    xlFlagSheet.write(xlRow,xlCol+37,ds.globalattributes['Flag132'])
    xlFlagSheet.write(xlRow,xlCol+38,ds.globalattributes['Flag133'])
    xlFlagSheet.write(xlRow,xlCol+39,ds.globalattributes['Flag134'])
    xlFlagSheet.write(xlRow,xlCol+40,ds.globalattributes['Flag140'])
    xlFlagSheet.write(xlRow,xlCol+41,ds.globalattributes['Flag150'])
