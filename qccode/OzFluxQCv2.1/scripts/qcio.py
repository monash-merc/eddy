...
def xl_write_series(cf,ds,level):
    ...
    xlFlagSheet.write(5,xlCol+4,'90:')
    xlFlagSheet.write(5,xlCol+5,ds.globalattributes['Flag90'])
    xlFlagSheet.write(5,xlCol+6,'91:')
    xlFlagSheet.write(5,xlCol+7,ds.globalattributes['Flag91'])
    xlFlagSheet.write(6,xlCol,'101:')
